...
# Configured with: './configure' '--prefix=/opt/qemu' '--target-list=arm-softmmu' '--enable-debug' '--audio-drv-list=alsa oss'
CONFIG_QEMU_SHAREDIR="/opt/qemu/share/qemu"
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_DEBUG_EXEC=y
HOST_LONG_BITS=64
...
VERSION=0.12.4
PKGVERSION=
SRC_PATH=/home/vonnyfly/android_src/qemu/qemu-s5pc110
