...
static void s5pc1xx_usb_otg_initial_reset(S5pc1xxUsbOtgState *s)
{
    int i;
...
{
    s5pc1xx_usb_otg_initial_reset(s);
                                            ...
                                            target_phys_addr_t offset)
{
    ...
    case 0x40:
        return s->phy.tune1;
    default:
        hw_error("s5pc1xx_usb_otg: bad read offset 0x" TARGET_FMT_plx "\n",
                 offset);
    }
}
                                         ...
                                         uint32_t val)
{
    ...
    case 0x40:
        ...
        break;
    default:
        hw_error("s5pc1xx_usb_otg: bad write offset 0x" TARGET_FMT_plx "\n",
                 offset);
    }
}
